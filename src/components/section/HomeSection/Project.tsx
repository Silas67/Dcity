...
const Project = () => {
  return (
    <div className="relative w-full mt-3 overflow-hidden md:px-[100px] py-24 bg-blue-950 px-8">
      <Motion className="flex justify-center z-30 relative text-white flex-col items-center">
        {/* Title */}
          ...
          <div className="w-full lg:w-1/2 p-4 rounded-xl mx-[10px] border basis-1/2">
            <form className="space-y-4">
              ...
              <button type="submit" className="w-full flexcent">
                <p className="w-[200px] bg-white text-primary p-3 rounded-[12px] hover:text-white hover:bg-primary hover:text-primary transition-all duration-500 font-semibold">
                  Save
                </p>
              </button>
            </form>
          ...
          <div className="basis-1/2 text-center">
            <div className="relative text-center">
              ...
              <div className="group absolute w-full h-full inset-0 bg-black bg-opacity-0 hover:bg-opacity-70 z-10 transition-all duration-500 flex items-center justify-center">
                ...
                >
                  <button className="primary-button flex flex-row gap-1 justify-center items-center hover:scale-105 max-sm:hidden max-md:flex">
                    View Projects
                  </button>
                </Link>
              </div>
