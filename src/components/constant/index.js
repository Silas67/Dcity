...
export const Sidebarlinks = [
  ...
  { href: "/about", label: "LIVESTREAM" },
];

export const Navlinks = [
  { href: "/about", label: "About", class: "text-muted_foreground" },
  { href: "/contact", label: "Contact", class: "text-muted_foreground" },
  { href: "/forms", label: "Online Forms", class: "text-muted_foreground" },
  { href: "/give", label: "Give", class: "text-muted_foreground" },
  { href: "/about", label: "Video On Demand", class: "text-muted_foreground" },
  { href: "/about", label: "Audio on Demand", class: "text-muted_foreground" },
  { href: "/about", label: "GMTV", class: "text-muted_foreground" },
  { href: "/contact", label: "Resources", class: "text-muted_foreground" },
  {
    href: "/about",
    label: "LIVESTREAM",
